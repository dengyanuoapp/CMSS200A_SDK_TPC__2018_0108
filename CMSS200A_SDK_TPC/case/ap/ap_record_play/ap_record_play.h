...
#ifndef AP_RECORD_PLAY_H
#define AP_RECORD_PLAY_H
...
#define RESULT_CURRENT_AP   RESULT_USER1

extern void decAddainit(adin_t ain);
extern void decAddaexit(void);

/* basal_en_pitch.c */
extern uint32 far pitch_write_page;         /* NOR FLASH 写入数据计数(单位:page) */
extern uint8 far pitch_write_flag;          /* 静音标志位 */

void show_load(void);

#endif  /* AP_RECORD_PLAY_H*/
