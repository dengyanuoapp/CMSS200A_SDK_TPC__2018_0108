...
#常驻数据段 
seg_data(0x680-0xa80)=?ED?COM_COM,?ED?AP_MAIN,?ED?FUNCTION,?ED?MW_BS_AD_CMDR_TTS,?ED?COM_REPORT,?ED?MW_CC_AD_DEC_R,?ED?MW_ANALOG_DEC,?ED?MW_DEC_EFFECT,D_RESERVE0
...
CTRL_bank4(0x2400-0x2cFF)=COM_REPORT,?HC?COM_REPORT,C_RESERVE8
CTRL_bank5(0x2400-0x2CFF)=?PR?AP_CLOCK_1,?HC?AP_CLOCK_1
#UI bank group
...
#CTRL_bank7(0x2800-0x2FFF)=MW_DEC_EFFECT,?HC?MW_DEC_EFFECT
#linein anglog
