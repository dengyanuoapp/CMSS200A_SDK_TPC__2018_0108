...
#if 0
#define BIT_RESOLUTION_16
#else
#define BIT_RESOLUTION_24
#endif
...
#define PLAY_MAXIMUM_VOLUME                 0x6000
#define PLAY_MINIMUM_VOLUME                 0x0000
#define PLAY_RESOTION_VOLUME                0x0600
#define RECORD_MAXIMUM_VOLUME               0x7000
#define RECORD_MINIMUM_VOLUME               0x0000
#define RECORD_RESOTION_VOLUME              0x1000
...
#define GET_ENDPOINT_CONTROL           0xA2
#define SAMPLING_FREQ_CONTROL          0x0100

#define EP0_MAX_PACKET_SIZE            0x40
#define ISO_OUT_MAX_PACKET_SIZE        0xc0
#define ISO_IN_MAX_PACKET_SIZE         0x64
...
typedef struct
{
    ...
    uint8 tSamFreq[3]; //Sample frequency.
...
typedef struct
{
    ...
    //usb_IAD_descriptor_t                    IAD_Audio_Descriptor;
